...
export default function ApiKeysPage() {
  ...
  return (
    <>
              ...
              {apiKeys.map((ak) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      onClick={() =>
                        setDeleteTarget({ id: ak.id, name: ak.name })
                      }
      ...
      <Modal
        isOpen={showApiKeyModal && !createdApiKey}
        onClose={() => {
              ...
              {ALLOWED_SCOPES.map((scope) => (
                ...
                >
                  ...
                  <span className="text-xs text-gray-400">
                    {scope === "read" && "- Read assets, findings, controls"}
      ...
      >
        ...
        <div className="mb-4">
          ...
          <div className="mt-1 flex items-center gap-2">
            ...
            <button
              onClick={() =>
                createdApiKey && handleCopyApiKey(createdApiKey.api_key)
              }
      ...
      <ConfirmDialog
        ...
        onConfirm={() => {
          if (deleteTarget) {
            handleDeleteApiKey(deleteTarget.id);
            setDeleteTarget(null);
          }
        }}
        title="Revoke API Key"
        message={`Revoke API key "${deleteTarget?.name ?? ""}"? This cannot be undone.`}
        confirmLabel="Revoke"
      />
    </>
  );
