...
from app.services.azure.checks.mysql import check_ssl_enforcement, check_public_access, check_min_tls_version
...
def _make_asset(resource_type="microsoft.dbformysql/flexibleservers", raw_properties=None):
    return Asset(id=uuid.uuid4(), cloud_account_id=uuid.uuid4(),
        ...
        resource_type=resource_type, name="test-mysql", region="westeurope",
